...
namespace Viscous
{
    ...
    internal class SolidityProjectDeployProvider : IDeployProvider
    {
        ...
        {
            //ToolWindowPane window = await ViscousPackage.Instance.ShowToolWindowAsync(typeof(DeploySolidityProjectToolWindow), 0, true, ViscousPackage.Instance.DisposalToken);
            var window = (DeploySolidityProjectToolWindow)await ViscousPackage.Instance.ShowToolWindowAsync(typeof(DeploySolidityProjectToolWindow), 0, true, ViscousPackage.Instance.DisposalToken);
