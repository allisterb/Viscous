...
namespace Viscous
{
    ...
    [ProjectTypeRegistration(ProjectTypeGuid, "Solidity", "#2", ProjectExtension, Language, resourcePackageGuid: ViscousPackage.PackageGuidString, PossibleProjectExtensions = ProjectExtension, Capabilities = UniqueCapability)]
    internal class SolidityUnconfiguredProject
    {
        ...
        public SolidityUnconfiguredProject(UnconfiguredProject unconfiguredProject)
        {
            ...
            //AsyncTasksService.RegisterCriticalAsyncTask(ProjectThreadingService.JoinableTaskFactory.RunAsync(ViscousPackage.InstallBuildSystemAsync));
        }
