...
using Viscous.UI.ViewModel;
using static Viscous.Result;
    ...
    public partial class DeploySolidityProjectToolWindowControl : UserControl
    {
        ...
        private async void DeployButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                VSUtil.LogToViscousWindow($"Deploying {contract[0]} contract to {network.Name}({network.NetworkChainId}) using account {deployProfile.DeployProfileAccount.ToHexCompact()} and endpoint {deployProfile.DeployProfileEndpoint}...");
