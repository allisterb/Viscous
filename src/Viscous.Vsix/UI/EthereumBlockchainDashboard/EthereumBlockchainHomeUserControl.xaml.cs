...
{
    /// <summary>
    /// Interaction logic for ViscousBlockchainHomeUserControl.xaml
    /// </summary>
    public partial class ViscousBlockchainHomeUserControl : UserControl
    {
        public ViscousBlockchainHomeUserControl()
        {
            InitializeComponent();
        }
