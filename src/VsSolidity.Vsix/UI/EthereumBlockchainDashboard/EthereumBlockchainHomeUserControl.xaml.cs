...
{
    /// <summary>
    /// Interaction logic for VsSolidityBlockchainHomeUserControl.xaml
    /// </summary>
    public partial class VsSolidityBlockchainHomeUserControl : UserControl
    {
        public VsSolidityBlockchainHomeUserControl()
        {
            InitializeComponent();
        }
