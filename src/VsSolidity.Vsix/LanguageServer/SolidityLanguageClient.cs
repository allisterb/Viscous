    ...
    public class SolidityLanguageClient : Runtime, ILanguageClient, ILanguageClientCustomMessage2
    {
        ...
        public async Task<Connection> ActivateAsync(CancellationToken token)
        {
            ...
            if (!VSUtil.VSServicesInitialized)
            {
                ...
                {
                    VSUtil.LogInfo("VsSolidity", "VsSolidity package services initialized.");
                }
                else
                {
                    Error("Could not initialize VsSolidity package services.");
                    return null;
                }
            }
            ...
            else
            {
                ...
                VSUtil.LogInfo("VsSolidity", "Installing Solidity language server...");
