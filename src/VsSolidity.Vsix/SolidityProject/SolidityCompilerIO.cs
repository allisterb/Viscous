...
namespace VsSolidity.SolidityCompilerIO2
{
    using Newtonsoft.Json;
    using System;
    using System.Collections.Generic;
...
public partial class PackageJsonFile
{
    public static PackageJsonFile Parse(string json) => JsonConvert.DeserializeObject<PackageJsonFile>(json, VsSolidity.Ethereum.SolidityCompilerIO.PackageJsonConverter.Settings);
    public static string ToJson(PackageJsonFile self) => JsonConvert.SerializeObject(self, VsSolidity.Ethereum.SolidityCompilerIO.PackageJsonConverter.Settings);
}
