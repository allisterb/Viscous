...
namespace VsSolidity
{
    public class VSUtil : Runtime
    {
        ...
        protected static string[] LogWindowNames = new string[] { "VsSolidity" };
        ...
        public static void LogToVsSolidityWindow(string text)
        {
            LogInfo("VsSolidity", text);    
            ActivateLogOutputPane("VsSolidity");
        }

        public static void LogVsSolidityInfo(string text) => LogInfo("VsSolidity", text);

        public static void LogVsSolidityError(string text) => LogError("VsSolidity", text);
        ...
        public static string LoadUserSettings(IServiceProvider serviceProvider, string propertyName, string defaultValue = null)
        {
            ...
            return settingsStore.GetString("VsSolidity", propertyName, defaultValue);
        }
        ...
        public static void SaveUserSettings(IServiceProvider serviceProvider, string propertyName, string value)
        {
            ...
            settingsStore.CreateCollection("VsSolidity");
            settingsStore.SetString("VsSolidity", propertyName, value);
        }

        public static void ShowModalErrorDialogBox(string text, string title = null)
        {
            ThreadHelper.ThrowIfNotOnUIThread();
            VsShellUtilities.ShowMessageBox(VsSolidityPackage.Instance, text, title ?? "VsSolidity error:",
        ...
        {
            ThreadHelper.ThrowIfNotOnUIThread();
            var dte = VsSolidityPackage.Instance.GetService<EnvDTE.DTE, EnvDTE80.DTE2>();
            if (dte == null)
            {
        ...
        public IProjectLockService GetProjectLockService()
        {
            ...
            IComponentModel componentModel = VsSolidityPackage.Instance.GetService<SComponentModel, IComponentModel>();
        ...
        {
            ThreadHelper.ThrowIfNotOnUIThread();
            var solutionService = VsSolidityPackage.Instance.GetService<SVsSolution, IVsSolution>();
