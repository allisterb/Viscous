...
public abstract class Runtime
{
    ...
    public static string ToolName { get; set; } = "VsSolidity";
    ...
    public static string VsSolidityDir => Path.Combine(AppDataDir, "VsSolidity");
    ...
    public static string RunFile => Path.Combine(VsSolidityDir, ToolName + ".run");
